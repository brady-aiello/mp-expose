...
//import co.touchlab.expose.ExposeComponentRegistrar
...
//    "EarlyReturn.kt", """
//import co.touchlab.expose.Expose
//
//@Expose
...
//    val result = compile(sourceFile = earlyReturn, ExposeComponentRegistrar(true))
...
//    val result = compile(sourceFile = earlyExit, ExposeComponentRegistrar(true))
//    assertEquals(KotlinCompilation.ExitCode.OK, result.exitCode)
//
