...
class ExposeGradlePlugin : KotlinCompilerPluginSupportPlugin {
  override fun apply(target: Project): Unit = with(target) {
    extensions.create("mpexpose", ExposeGradleExtension::class.java)
  }
  ...
  override fun applyToCompilation(
    ...
    val extension = project.extensions.getByType(ExposeGradleExtension::class.java)
